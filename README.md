...
Install the nuget package:  [Install-Package Mossharbor.AzureWorkArounds.ServiceBus -Version 1.0.1](https://www.nuget.org/packages/Mossharbor.AzureWorkArounds.ServiceBus/1.0.1#)
